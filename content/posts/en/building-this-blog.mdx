...
description: "Implementation notes on building a static-first, local-MDX blog with typed frontmatter and predictable publishing."
date: "2026-06-23"
category: "tech"
...
That means archive pages, tag pages, RSS, and Open Graph metadata all share the same source of truth.
